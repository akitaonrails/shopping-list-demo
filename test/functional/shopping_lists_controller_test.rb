...
class ShoppingListsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_list" do
    assert_difference('ShoppingList.count') do
      post :create, shopping_list: { description: @shopping_list.description, name: @shopping_list.name, total: @shopping_list.total }
    end
  ...
  test "should update shopping_list" do
    put :update, id: @shopping_list, shopping_list: { description: @shopping_list.description, name: @shopping_list.name, total: @shopping_list.total }
    assert_redirected_to shopping_list_path(assigns(:shopping_list))
  end
